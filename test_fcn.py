...
def main(cfg):
    ...
    inference(model, data_path='./data/leftImg8bit/test/', save_path=f"./outputs/fcn/", transform=transform_val_test)

if __name__=="__main__":
    parser = argparse.ArgumentParser(description="FCN Evaluation")
